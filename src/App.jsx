...
/>
            ...
            <div className="mt-5 space-y-2">
              <button
                ...
                className="w-full bg-green-500 hover:bg-green-600 text-black font-bold py-3 rounded-xl transition-all shadow-md active:scale-95"
              >
                Enviar Comprobante por WhatsApp
              </button>
              <button
                onClick={() => setSelectedProduct(null)}
                className="w-full bg-transparent hover:bg-gray-800 text-gray-400 py-2 rounded-xl text-xs transition-colors"
              >
                Cancelar
              </button>
            </div>
