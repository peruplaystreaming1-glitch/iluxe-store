...
export default function App() {
  // Carrito con almacenamiento local para no perder productos
  ...
  return (
    <div className="bg-black text-white min-h-screen relative font-sans">
      ...
      {/* ÍCONO DE CARRITO EN EL ENCABEZADO */}
      ...
      <main className="p-8 max-w-5xl mx-auto">
        <h2 className="text-2xl font-bold text-[#d4af37] mb-6 border-b border-zinc-800 pb-2">Nuestros Servicios</h2>
